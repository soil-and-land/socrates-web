...
function socratesToData() {
  try {
    state.socrates.soil['soil_properties'] = state.soilProperties?.id || null;
  ...
  <el-row :gutter="20" class="p-6">
    ...
    <el-col :span="24">
      ...
      <el-row>
        ...
        <el-col class="py-1" :xl="8" :lg="8" :md="8" :sm="8" :xs="24">
          <div class="px-1">
            <el-input v-model="state.rotationLength" placeholder="(eg. Peas - Wheat would be 2)">
      ...
      <div>
        ...
        <el-row v-for="(rotation, idx) of state.rotationTable" :key="idx" class="border-solid border-1 border-gray-200">
